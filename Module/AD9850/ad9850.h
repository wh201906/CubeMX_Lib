...
#define AD9850_RESET_CLKEN() __HAL_RCC_GPIOB_CLK_ENABLE()
#define AD9850_FQUD_CLKEN() __HAL_RCC_GPIOB_CLK_ENABLE()
#define AD9850_WCLK_CLKEN() __HAL_RCC_GPIOB_CLK_ENABLE()
#define AD9850_D_CLKEN() __HAL_RCC_GPIOE_CLK_ENABLE()
