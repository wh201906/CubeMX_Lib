...
//////////////////////////////////////////////////////////////////////////////////
#define LCD_BACKLIGHT_CLKEN() __HAL_RCC_GPIOB_CLK_ENABLE()
#define LCD_BACKLIGHT_GPIO GPIOB
#define LCD_BACKLIGHT_PIN GPIO_PIN_1
#define LCD_BACKLIGHT_STATE GPIO_PIN_RESET
#define LCD_LED() HAL_GPIO_WritePin(LCD_BACKLIGHT_GPIO, LCD_BACKLIGHT_PIN, LCD_BACKLIGHT_STATE) // for backlight
typedef struct
{
  volatile uint16_t LCD_REG;
  volatile uint16_t LCD_RAM;
} LCD_TypeDef;
// Bank1.sector1->0x60000000, A18->7FFFE
...
void LCD_ShowChar(uint16_t x, uint16_t y, uint8_t ch, uint8_t size, uint8_t mode);                      //显示一个字符
uint8_t LCD_ShowNum(uint16_t x, uint16_t y, uint32_t num, uint8_t size);                                //显示一个数字
