...
#define SI4463_GPIO0_PORT GPIOD
#define SI4463_GPIO0_CLKEN() __HAL_RCC_GPIOD_CLK_ENABLE()
#define SI4463_GPIO0_PIN GPIO_PIN_0

#define SI4463_GPIO1_PORT GPIOD
#define SI4463_GPIO1_CLKEN() __HAL_RCC_GPIOD_CLK_ENABLE()
#define SI4463_GPIO1_PIN GPIO_PIN_1

#define SI4463_GPIO2_PORT GPIOC
#define SI4463_GPIO2_CLKEN() __HAL_RCC_GPIOC_CLK_ENABLE()
#define SI4463_GPIO2_PIN GPIO_PIN_8

#define SI4463_GPIO3_PORT GPIOC
#define SI4463_GPIO3_CLKEN() __HAL_RCC_GPIOC_CLK_ENABLE()
#define SI4463_GPIO3_PIN GPIO_PIN_9
...
#define SI4463_GPIO0_R() (!!(SI4463_GPIO0_PORT->IDR & SI4463_GPIO0_PIN))
#define SI4463_GPIO1_R() (!!(SI4463_GPIO1_PORT->IDR & SI4463_GPIO1_PIN))
#define SI4463_GPIO2_R() (!!(SI4463_GPIO2_PORT->IDR & SI4463_GPIO2_PIN))
#define SI4463_GPIO3_R() (!!(SI4463_GPIO3_PORT->IDR & SI4463_GPIO3_PIN))
#define SI4463_GPIO0_W(__PINSTATE__) (SI4463_GPIO0_PORT->BSRR = (uint32_t)(SI4463_GPIO0_PIN) << ((__PINSTATE__) ? (0u) : (16u)))
#define SI4463_GPIO1_W(__PINSTATE__) (SI4463_GPIO1_PORT->BSRR = (uint32_t)(SI4463_GPIO1_PIN) << ((__PINSTATE__) ? (0u) : (16u)))
#define SI4463_GPIO2_W(__PINSTATE__) (SI4463_GPIO2_PORT->BSRR = (uint32_t)(SI4463_GPIO2_PIN) << ((__PINSTATE__) ? (0u) : (16u)))
#define SI4463_GPIO3_W(__PINSTATE__) (SI4463_GPIO3_PORT->BSRR = (uint32_t)(SI4463_GPIO3_PIN) << ((__PINSTATE__) ? (0u) : (16u)))
