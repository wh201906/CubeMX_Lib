...
#include "main.h"
#include "config/315_OOK_direct_2.5k.h"
...
#define SI4463_GPIO2_PORT GPIOD
#define SI4463_GPIO2_CLKEN() __HAL_RCC_GPIOD_CLK_ENABLE()
#define SI4463_GPIO2_PIN GPIO_PIN_2

#define SI4463_GPIO3_PORT GPIOD
#define SI4463_GPIO3_CLKEN() __HAL_RCC_GPIOD_CLK_ENABLE()
...
#define SI4463_GPIO0_W() (SI4463_GPIO0_PORT->BSRR = (uint32_t)(SI4463_GPIO0_PIN) << ((__PINSTATE__) ? (0u) : (16u)))
#define SI4463_GPIO1_W() (SI4463_GPIO1_PORT->BSRR = (uint32_t)(SI4463_GPIO1_PIN) << ((__PINSTATE__) ? (0u) : (16u)))
#define SI4463_GPIO2_W() (SI4463_GPIO2_PORT->BSRR = (uint32_t)(SI4463_GPIO2_PIN) << ((__PINSTATE__) ? (0u) : (16u)))
#define SI4463_GPIO3_W() (SI4463_GPIO3_PORT->BSRR = (uint32_t)(SI4463_GPIO3_PIN) << ((__PINSTATE__) ? (0u) : (16u)))
